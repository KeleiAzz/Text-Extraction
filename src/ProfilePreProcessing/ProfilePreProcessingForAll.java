 ...
 * @author SCRC
 */
public class ProfilePreProcessingForAll
{
...
//		String lhrConteng = new String("");
		...
		try {
			...
			{
				srmConteng = getCompanyProfile(companyNames.get(i),"SS",conn, tablename);
...
//
	...
	private static String getCompanyProfile(String companyName,String category,Connection conn, String tablename)
	{
